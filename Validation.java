...
public class Validation {
	...
	// check overflow
	public boolean checkMove(int row, int col, int player) {
	...
	public int updateMove(int col, int player) {
		//System.out.println("updatemove"+col);
...
//					}System.out.println();
//				}
				//System.out.println("row"+(5-row)+",col"+col);
				if(player==1) {
